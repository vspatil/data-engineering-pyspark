...
df_green = spark.read.parquet('../notebooks/data/raw/green/*/*')
...
df_yellow = spark.read.parquet('../notebooks/data/raw/yellow/*/*')
...
#    Spark_standalone_cluster.py \
#       --input_green ='../notebooks/data/raw/green/*/*'\
#       --input_yellow='../notebooks/data/raw/yellow/*/*'\
#       --output ='../notebooks/data/report/revenue/'
